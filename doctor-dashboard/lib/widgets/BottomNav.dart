...
import 'package:doctor/blocs/bottom_navigation/bloc.dart';
    ...
    return BlocBuilder<BottomNavigationBloc, BottomNavigationState>(
      builder: (context, state) {
        List<NavigationItem> items = [
          ...
          NavigationItem(Icon(Icons.add_circle_outline), Text('Пациент')),
          NavigationItem(Icon(OMIcons.notes), Text('Нотатки')),
